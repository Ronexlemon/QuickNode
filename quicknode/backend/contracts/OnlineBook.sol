...
contract OnlineBookStore is Ownable {
    struct BookStore {
        ...
        uint bookId;
        bool sold;
        //BookContractAddress 0x1D68e74456fA88F1d54298CBAba61acbBcd0D7FD
    }
    ...
    function addBook(
        ...
        string calldata _bookdescription,
        uint _bookprice
    ) public {
    ...
    function buyBook(uint _bookId) public payable {
        require(
            bookstore[_bookId].owner != msg.sender,
            "Please you can not buy your own book "
        );
